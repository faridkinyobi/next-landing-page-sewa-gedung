...
export default function Settings() {
  return (
    <main className="bg-blue-30 w-screen-sm h-screen">
      <NavbarLending />
      <div className="flex flex-wrap gap-10 mx-10 md:mx-24 my-16">
        <div className="bg-white-20 w-full h-56  text-center rounded-3xl shadow-xl shadow-gray-700 md:max-w-xs">
